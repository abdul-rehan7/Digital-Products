  ...
  return (
    <div className="">
      ...
      <div className=" bg-gray-100 p-8 text-justify lg  lg:p-6 space-y-6 text-lg lg:text-xl flex flex-col items-center lg:text-center justify-center">
        ...
        <p>Our mission is simple: to offer a platform where you can find top-notch digital products that meet your needs and boost your success. We believe in making digital content easy to access, affordable, and, most importantly, valuable</p>
      </div>
    </div>
  );
}
